...
<body>
	...
	<table style="width: 100%">
		...
		<tr>
			...
			<td><input type="text" id="name" name="name">
				<input type="hidden" id="staff_no" value="<c:out value ='${staff_no}'/>">
			</td>
			<th>주민번호</th>
	...
	<button id="update" value="수정">수정</button>
	<button id="delete" value="삭제">삭제</button>
	
	<!-- Setting.js -->
	<script src="/resources/javascript/setting.js"></script>
	<!-- Input.js -->
	<script src="/resources/javascript/updel.js"></script>	
